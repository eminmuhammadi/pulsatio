...
func (c *pingPongClient) Ping(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PongMessage, error) {
	out := new(PongMessage)
...
func (UnimplementedPingPongServer) Ping(context.Context, *PingMessage) (*PongMessage, error) {
